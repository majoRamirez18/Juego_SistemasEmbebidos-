...
El archivo es un Arduino file pues se usó el IDE de Arduino para poder programar su función y también lo encontraras elaborado en platformio.
...
El pdf del Juego (parte 2) siguiente 2 filas de leds.pdf es la otra parte faltante del esquema del juego que son las demás filas (seis) de la matriz a formar.

Con estos esquemas te puedes guiar para saber cómo irán cada uno de los componentes electrónicos: leds, resistencias, arduino, botones y registros de desplazamiento. Te recomendamos buscar el símbolo electrónico de cada componente si no estas familiarizado con el mismo.
...
Soldamos los cables de cada LED cuidando que a la patita del led en la cual soldamos los cables sea la más grande pues es (+), la otra patita es la mas pequeña (-) la cual es la de tierra y por ende irán las resistencias conectadas a esa patita pequeña.
Para esto también te explicamos los registros de desplazamiento que tienen la siguiente estructura:
...
Retomando lo anterior los cables conectados al led de la patita más larga irán al registro de desplazamiento, comenzando desde el exterior y avanzando hacia el interior, siguiendo el diagrama del proyecto.
...
Las resistencias que ya están soldadas a la patita del led están bien. El otro lado de las resistencias las vamos a conectar entre ellas como en fila. Esto se le llama puentear a tierra pues la última resistencia que se soldé va a ir a tierra conectada.
...
Hay que identificar los pines de corriente y de tierra, para ello checa la siguiente imagen.
![image](https://github.com/majoRamirez18/Juego_SistemasEmbebidos-/assets/106703825/d8d96c82-1d94-4ed0-b240-d34dc6b3b568)

Los cables negros son tierra y los cables rojos son corriente. En el prototipo conectarlas de esta forma.
...
Los pines son los cables de color: azul, verde y amarillo. Si los conectamos entre si se vería de la siguiente manera
![image](https://github.com/majoRamirez18/Juego_SistemasEmbebidos-/assets/106703825/e77bc125-c33e-4973-b545-a2fbbe1ea8f7)

De forma física debió de quedarte así
...
Sacamos la moda que es 204, partiendo de ello sacamos la medida dividiéndola entre 6 para tener un límite de voltaje de cada botón y así no se confunda el usuario al momento apretar uno u otro botón.
 ![image](https://github.com/majoRamirez18/Juego_SistemasEmbebidos-/assets/106703825/40a21a70-2c16-41f3-8e01-f83c7fbaf413)


Definir el límite de voltaje. Como se ve en la ilustración 3 los límites de cada botón no se topan uno con el otro por lo que la medida de dividirlo entre 6 nos va a beneficiar. 
...
# 3. Montar todo.
Tenemos el botón y la matriz. Montamos todo en la arduino.
...
1. Arduino. Usa el IDE de arduino, conecta tu arduino y carga el código del proyecto
2. Platformio. Usa Visual Studio Code y descarga la extensión de platformio, carga el proyecto y listo. Sino también puede hacerlo en forma de cmd.

# 4. Consideraciones finales.

Puede alimentar el proyecto con una batería de 5 volts o con tu computadora. Si tienes alguna duda no dudes en escribirnos y te ayudaremos lo antes posible.
